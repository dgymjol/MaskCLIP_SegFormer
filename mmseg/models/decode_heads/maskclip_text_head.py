...
class MaskClipTextHead(BaseDecodeHead):
    ...
    def forward_test(self, inputs, img_metas, test_cfg):
        ...
        if self.vit:
            ...
            if self.attn_pooling:
                ...
                v = self.v_proj(x)
                feat = self.c_proj(v)
        output = self.cls_seg(feat, class_weights)
    ...
    def cls_seg(self, feat, class_weights):
        ...
        if class_weights is None:
            ...
            weighted_output = torch.mul(batch_class_weights, output)
    ...
    def forward_train(self, inputs, img_metas, gt_semantic_seg, train_cfg):
        raise RuntimeError('MaskClipText is not trainable. Try MaskClipText+ instead.')