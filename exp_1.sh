...
python tools/train.py configs/maskclip_plus/anno_free/maskclip_plus_vit16_deeplabv2_r101-d8_480x480_4k_pascal_context_59.py --cfg-options data.samples_per_gpu=8  optimizer.lr=0.005 optimizer.weight_decay=0.00025 --work-dir work_dirs/anno_free_4k/vit-dlv2 
...
# org : gpu_nums = 4(in papers) samples_per_gpu=4 optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0005)
python tools/train.py configs/maskclip_plus/anno_free/maskclip_plus_r50_deeplabv2_r101-d8_480x480_4k_pascal_context_59.py --cfg-options data.samples_per_gpu=8 optimizer.lr=0.005 optimizer.weight_decay=0.00025 --work-dir work_dirs/anno_free_4k/r50-dl2
...
python tools/train.py configs/maskclip_plus/anno_free/maskclip_plus_vit16_segformer_b0_480x480_8k_pascal_context_59.py --cfg-options data.samples_per_gpu=16 optimizer.lr=0.000024 optimizer.weight_decay=0.004 --work-dir work_dirs/anno_free/vit-sfb0-8k-test-8

# lrs=(0.00012 0.0012 0.006  0.0006)
# for lr in ${lrs[@]}
#     do 
#         python tools/train.py configs/maskclip_plus/anno_free/maskclip_plus_vit16_segformer_b0_480x480_8k_pascal_context_59.py --cfg-options optimizer.lr=${lr} data.samples_per_gpu=8 --work-dir work_dirs/anno_free/vit-sfb0-8k-${lr}-8
#     done
...
# # default : gpu_nums = 8, data.samples_per_gpu=4 | optimizer = dict(type='SGD', lr=0.004, momentum=0.9, weight_decay=0.0001)
...
# bash tools/dist_train.sh configs/maskclip_plus/anno_free/maskclip_plus_vit16_segformer_b0_480x480_4k_pascal_context_59.py 2 --cfg-options optimizer.lr=0.00012 data.samples_per_gpu=4 --work-dir work_dirs/anno_free/vit-sfb0-4k-base-test
