...
bash tools/dist_train.sh configs/maskclip_plus/anno_free/maskclip_plus_vit16_deeplabv2_r101-d8_480x480_4k_pascal_context_59.py 2 --cfg-options optimizer.lr=0.005 optimizer.weight_decay=0.00025 --work-dir work_dirs/anno_free_4k/vit-dlv2 
...
# org : gpu_nums = 4(in papers) samples_per_gpu=4 optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0005)
bash tools/dist_train.sh configs/maskclip_plus/anno_free/maskclip_plus_r50_deeplabv2_r101-d8_480x480_4k_pascal_context_59.py 2 --cfg-options optimizer.lr=0.005 optimizer.weight_decay=0.00025 --work-dir work_dirs/anno_free_4k/r50-dl2
